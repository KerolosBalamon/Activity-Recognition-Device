...
// WiFi network info.
const char *ssid =  "Kerolos";     // Enter your WiFi Name
const char *pass =  "00000000"; // Enter your WiFi Password

unsigned long Channel_ID = 1747734; // Your Channel ID
const char * myWriteAPIKey = "68DQCGW28ERVOII6"; //Your write API key
    ...
    {            
      ...
      {                
        char c = client.read();                // read a byte
          ...
          {     
            client.print("<html><title> ESP32 WebServer</title>");
